...
-- Equation(s):
-- \memROM~6_combout\ = ( \Endereco[0]~input_o\ & ( \Endereco[2]~input_o\ & ( (\memROM~0_combout\ & !\Endereco[3]~input_o\) ) ) ) # ( !\Endereco[0]~input_o\ & ( \Endereco[2]~input_o\ & ( (\memROM~0_combout\ & !\Endereco[3]~input_o\) ) ) ) # ( 
-- \Endereco[0]~input_o\ & ( !\Endereco[2]~input_o\ & ( (\memROM~0_combout\ & (!\Endereco[1]~input_o\ & !\Endereco[3]~input_o\)) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000001100000000000000110011000000000011001100000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \memROM~5_combout\ = ( \Endereco[0]~input_o\ & ( \Endereco[2]~input_o\ & ( (!\Endereco[3]~input_o\ & \memROM~0_combout\) ) ) ) # ( \Endereco[0]~input_o\ & ( !\Endereco[2]~input_o\ & ( (\Endereco[1]~input_o\ & (!\Endereco[3]~input_o\ & \memROM~0_combout\)) 
-- ) ) ) # ( !\Endereco[0]~input_o\ & ( !\Endereco[2]~input_o\ & ( (!\Endereco[3]~input_o\ & \memROM~0_combout\) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000110000001100000001000000010000000000000000000000110000001100",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \memROM~4_combout\ = ( \Endereco[0]~input_o\ & ( \Endereco[2]~input_o\ & ( (\memROM~0_combout\ & (\Endereco[1]~input_o\ & !\Endereco[3]~input_o\)) ) ) ) # ( !\Endereco[0]~input_o\ & ( !\Endereco[2]~input_o\ & ( (\memROM~0_combout\ & 
-- (!\Endereco[1]~input_o\ & !\Endereco[3]~input_o\)) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0011000000000000000000000000000000000000000000000000001100000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	datab => \ALT_INV_memROM~0_combout\,
...
-- Equation(s):
-- \memROM~3_combout\ = ( \Endereco[0]~input_o\ & ( \Endereco[2]~input_o\ & ( (\Endereco[1]~input_o\ & (!\Endereco[3]~input_o\ & \memROM~0_combout\)) ) ) ) # ( !\Endereco[0]~input_o\ & ( \Endereco[2]~input_o\ & ( (!\Endereco[3]~input_o\ & \memROM~0_combout\) 
-- ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000000000000000000000001100000011000000010000000100",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \ALT_INV_Endereco[1]~input_o\,
