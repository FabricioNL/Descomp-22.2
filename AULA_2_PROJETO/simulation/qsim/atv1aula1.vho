...
-- PC_OUT[0]	=>  Location: PIN_L17,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \PC|DOUT[2]~1_combout\ = ( \PC|DOUT\(2) & ( \PC|DOUT\(1) & ( !\PC|DOUT[0]~DUPLICATE_q\ ) ) ) # ( !\PC|DOUT\(2) & ( \PC|DOUT\(1) & ( \PC|DOUT[0]~DUPLICATE_q\ ) ) ) # ( \PC|DOUT\(2) & ( !\PC|DOUT\(1) ) )
